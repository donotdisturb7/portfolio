...
**Technologies utilisées :** Mathématiques appliquées, théorie des graphes, statistiques, NumPy
...
**Technologies utilisées :** Python, threading, queues, structures de données optimisées, cache management
...
**Problématique :** Comment faire qu'un LLM généraliste réponde précisément sur l'IUT de la Martinique sans halluciner d'informations ?

**Solution RAG (Retrieval-Augmented Generation) :**
Le RAG combine deux technologies complémentaires :
- **Recherche sémantique** pour trouver l'information pertinente dans une base de connaissances
- **Génération de texte** pour formuler une réponse cohérente basée sur ces informations
...
- Implémenté l'architecture RAG pour éviter les hallucinations du modèle

**Technologies utilisées :** LLM (Large Language Models), Speech-to-Text AI, Neural TTS, prompt engineering, ML intent detection, audio processing algorithms, RAG architecture
...
**Technologies utilisées :** Outils de profiling Python, métriques de performance, analyse d'impact énergétique  